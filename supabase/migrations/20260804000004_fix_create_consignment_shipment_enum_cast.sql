-- ============================================================
-- 修正 create_consignment_shipment 的 enum cast bug（v1.4.1 hotfix）
-- 原因：UPDATE order_items.status 使用 CASE 回傳 text，
--   而 order_items.status 為 order_item_status enum，無法隱式轉換。
--   觸發情境：出貨時重用既有 order_item（v1.4 草稿鏡像的標準路徑），
--   例如回滾後重新出貨。
-- ============================================================
