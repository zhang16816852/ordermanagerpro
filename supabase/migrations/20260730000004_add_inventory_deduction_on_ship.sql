-- 在所有出貨流程扣減庫存，刪除銷貨單時回補庫存
-- 修改 4 個 RPC：ship_from_pool, direct_ship_order, create_order_with_sales_note, delete_sales_note

-- ============================================================
-- 1. ship_from_pool：出貨時扣減 product_inventory
-- ============================================================
...
-- ============================================================
-- 2. direct_ship_order：出貨時扣減 product_inventory
-- ============================================================
...
-- ============================================================
-- 3. create_order_with_sales_note：建立立即出貨訂單時扣減庫存
-- ============================================================
...
-- ============================================================
-- 4. delete_sales_note：刪除銷貨單時回補庫存
-- ============================================================
