-- ============================================================
-- Support per-item warehouse for shipping RPCs:
-- 1. shipping_pool gets warehouse_id column
-- 2. ship_from_pool: read warehouse_id from pool + p_warehouse_map
-- 3. direct_ship_order: p_warehouse_map for per-item override
-- 4. create_order_with_sales_note: warehouse_id per item in p_items
-- ============================================================

-- ============================================================
-- 1. Add warehouse_id to shipping_pool
-- ============================================================

ALTER TABLE public.shipping_pool
ADD COLUMN warehouse_id UUID REFERENCES public.warehouses(id) ON DELETE SET NULL;

-- ============================================================
-- 2. ship_from_pool
--    Read warehouse_id from pool item; fallback to p_warehouse_map
--    per order_item_id, then p_warehouse_id, then 'own'
-- ============================================================
...
-- ============================================================
-- 3. direct_ship_order
--    Add p_warehouse_map for per-item warehouse override
-- ============================================================
...
-- ============================================================
-- 4. create_order_with_sales_note
--    Read warehouse_id from each item in p_items
-- ============================================================
